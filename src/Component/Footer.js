      ...
      <div class="mx-auto flex max-w-6xl flex-col items-start space-x-8 md:flex-row">
        ...
        <div class="mt-8 grid grid-cols-2 gap-6 md:mt-0 lg:w-3/4 lg:grid-cols-3">
          <div class="mb-8 lg:mb-0">
            <p class="mb-6 text-lg font-semibold  text-white ">Company</p>
          ...
          <div class="mb-8 lg:mb-0">
            <p class="mb-6 text-lg font-semibold  text-white ">Contact Us</p>
            <ul class="flex flex-col space-y-4 text-[14px] font-medium  text-white">
            <li>Help & Support</li>
          ...
          <div class="mb-8 lg:mb-0">
            <p class="mb-6 text-lg font-semibold  text-white">We deliver to</p>
            <ul class="flex flex-col space-y-4 text-[14px] font-medium  text-white">
              <li>Odisha</li>
              <li>Bangalore</li>
              <li>Hyderabad</li>
